...
public class IndexArrayList implements IndexInterface {
    ...
    private ArrayList<Citation> citationIndex;  
    private ArrayList<Keyword> keywordIndex = new ArrayList<Keyword>();
    ...
    public IndexArrayList(int totalNumCitations){
        ...
        citationIndex = new ArrayList<Citation>();
    }//end Constructor
    
    public ArrayList<Keyword> getKeywordIndex(){
        return keywordIndex;
    }//end getKeywordIndex
    
    public ArrayList<Citation> getCitationIndex(){
    ...
    // list. This returns -1 if unsuccessful and the ID of the added  citation otherwise
        ...
        if(placeHolder < numCitationsInIndex){
            for(int i = numCitationsInIndex-1; i > placeHolder; i--){
                ...
                //add new null citation with which to work.
            ...
            if(citationIndex.size() != numCitationsInIndex){
                ...
                //HERE! This needs to update the IDs correctly
                citationIndex.get(numCitationsInIndex).updateID(numCitationsInIndex);
                sortKeywords();
    ...
    */
    ...
    private void mergeSort(ArrayList<Citation> citationArray, int arrayLength){
    // Sorts the values array using 
    //the merge sort algorithm.
      if (citationArray.size() > 1)
      { 
        ArrayList<Citation> left = new ArrayList<Citation>();                
        ArrayList<Citation> right = new ArrayList<Citation>();
    ...
    private void merge(ArrayList<Citation> citationArray, ArrayList<Citation> left, ArrayList<Citation> right, int leftOldID, int rightOldID){
    ...
    private int[] citationBinarySearch(ArrayList<Citation> index, String key){        
    ...
    public int[] keywordBinarySearch(ArrayList<Keyword> index, String key){                   
    ...
    private ArrayList<Keyword> keywordInsertionSort(ArrayList<Keyword> sortedKeywordIndex, int sortedIndexLength){
        int i, j;
        int iMin;
